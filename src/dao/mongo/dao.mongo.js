...
class MongoDAO {
  ...
  create = async (data) => {
    try {
      ...
      throw `Error MongoDAO create: ${error.message}`;
    }
  };
  findById = async (id, populateOptions = {}) => {
    try {
      ...
      throw `Error MongoDAO findById: ${error.message}`;
    }
  };
  findByIdAndUpdate = async (id, data, populateOptions = {}) => {
    try {
      ...
      throw `Error MongoDAO findByIdAndUpdate: ${error.message}`;
    }
  };
  findByIdAndDelete = async (id, populateOptions = {}) => {
    try {
      ...
      throw `Error MongoDAO findByIdAndDelete: ${error.message}`;
    }
  };
  findOne = async (query = {}, populateOptions = {}) => {
    try {
      ...
      throw `Error MongoDAO findOne: ${error.message}`;
    }
  };
  findAll = async (query = {}, options = {}, populateOptions = {}) => {
    try {
      ...
      throw `Error MongoDAO findAll: ${error.message}`;
    }
  };
  save = async (data, populateOptions = {}) => {
    try {
      ...
      throw `Error MongoDAO save: ${error.message}`;
    }
  };
  countDocuments = async (query = {}, populateOptions = {}) => {
    try {
      ...
      throw `Error MongoDAO countDocuments: ${error.message}`;
    }
  };
  paginate = async (query = {}, options = {}) => {
    try {
      ...
      throw `Error MongoDAO paginateData: ${error.message}`;
    }
  };
  deleteOne = async (query) => {
    try {
      ...
      throw `Error MongoDAO deleteOne: ${error.message}`;
    }
  };
}
